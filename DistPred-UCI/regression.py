...
class Diffusion(object):
    def __init__(self, args, config, device=None):
        ...
        self.num_timesteps = 0 #config.diffusion.timesteps
    ...
    def test(self):
        ...
        # y_crps_aux_model = self.evaluate_guidance_model(dataset_object, test_loader)
        # logging.info("Test set unnormalized y CRPS on trained {} guidance model is {:.8f}.".format(
        #     config.diffusion.conditioning_signal, y_crps_aux_model))
        ...
        with torch.no_grad():
            ...
            for step, xy_batch in enumerate(test_loader):
                ...
                y_0_hat_tile = y_0_hat_batch.view(-1,1)
                y_tile_seq = [y_0_hat_tile]
