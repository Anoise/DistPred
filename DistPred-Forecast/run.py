import argparse
import torch
from experiments.exp_decom import Exp_Decom
import random
import numpy as np
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, required=True, default='iTransformer', help='model name, options: [iTransformer, iInformer, iReformer, iFlowformer, iFlashformer]')
    ...
    # forecasting task
    parser.add_argument('--bins', type=int, default=100, help='prediction sequence length')
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            setting = '{}_{}_{}_bn{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_fc{}_eb{}_dt{}_{}_{}_{}'.format(
                args.model_id,
                args.model,
                args.data,
                args.bins,
